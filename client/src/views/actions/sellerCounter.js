...
.controller('sellerCounterController', ['$scope', '$uibModalInstance', 'ClientContext', 'bid', function ($scope, $uibModalInstance, ClientContext, bid) {
	...
	$scope.counter = function() {
		...
		ClientContext.sellerCounterBid(request).then(function (result) {
			if (result.isSuccess) {				
