...
.controller('sellerSendMessageController', ['$scope', '$uibModalInstance', 'ClientContext', 'bid', function ($scope, $uibModalInstance, ClientContext, bid) {
	...
	$scope.sendMessage = function() {
		...
		var request = { 'BidId' : $scope.bid.Id, 'Message' : $scope.message, 'IsListingAction' : true };
